...
- [ ] **PS1.1** - Install Rust and Cargo (if not installed)
- [ ] **PS1.2** - Install Node.js and npm/pnpm
- [ ] **PS1.3** - Install Tauri CLI: `cargo install tauri-cli`
- [ ] **PS1.4** - Create new Tauri project: `cargo create-tauri-app`
- [ ] **PS1.5** - Choose React + TypeScript for frontend
